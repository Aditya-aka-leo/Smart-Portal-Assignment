...
- The swagger  should run on  [Link Text](http://20.244.93.34:8081/api-docs/) by default.
- The Client Status Update should run on [Link Text](http://20.244.93.34:3000) by default.
